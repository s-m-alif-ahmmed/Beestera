...
@section('title', 'CMS - Train-Control')

@section('content')
    {{-- PAGE-HEADER --}}
    <div class="page-header">
        <div>
            <h1 class="page-title">CMS - Train - Control</h1>
        </div>
    ...
    <div class="col">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('cms.train.control.banner.update') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="text-center col">
                                <button class="btn btn-primary" type="button" onclick="window.location.href='{{ route('cms.train.control.banner') }}'">Back</button>
