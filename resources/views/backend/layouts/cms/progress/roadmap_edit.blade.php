...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">RoadMap</a></li>
            </ol>
        </div>
    </div>
    {{-- PAGE-HEADER --}}
    ...
    <div class="col">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('cms.roadmap.banner.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="text-center col">
                                <button class="btn btn-primary" type="button" onclick="window.location.href='{{ route('cms.roadmap.banner') }}'">Back</button>
