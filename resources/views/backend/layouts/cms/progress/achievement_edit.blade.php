...
@section('content')
    ...
    <div class="col">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('cms.achievement.banner.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="text-center col">
                                <button class="btn btn-primary" type="button" onclick="window.location.href='{{ route('cms.achievement.banner') }}'">Back</button>
