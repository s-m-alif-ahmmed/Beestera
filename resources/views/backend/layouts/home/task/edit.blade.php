...
@section('content')
    ...
    <div class="col">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('user.task.update', ['id' => $task->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                        placeholder="Enter here Task Description" id="description" rows="7">{{ $task->description ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="achievement" class="form-label">Achivement</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('person_focus_description') is-invalid @enderror"
                                        ...
                                        value="{{ $task->person_focus_description ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('player_focus_description') is-invalid @enderror"
                                        ...
                                        value="{{ $task->player_focus_description ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('starting_date') is-invalid @enderror"
                                        name="starting_date" placeholder="Enter here Date " id="starting_date"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('ending_date') is-invalid @enderror"
                                        name="ending_date" placeholder="Enter here date " id="ending_date"
